...
<script src="/static/plugins/socket/sockjs.min.js"></script>
...
<script>
    ...
    function connect() {
        var socket = new SockJS('/itbc-socket');
    ...
    $(function () {
        ...
        $("#send").click(function () {
            ...
            var content = "{'type':'text','content':'" + $("#message-to-send").val() + "','sender':'"+ITBC._userId+"','toType':'USER','receiver':'"+target+"'}";
