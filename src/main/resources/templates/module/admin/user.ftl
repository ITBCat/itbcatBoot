        ...
        <div class="row">
            <div class="sixteen wide column">
                <@shiro.hasPermission name="admin:user:add">
                    <a class="ui left aligned green icon button" href="${ITBCAdmin}/user/add-user" style="margin-left: 10px;"><i class="write icon"></i> 添加用户 </a>
                </@shiro.hasPermission>
                                        ...
                                        <tr>
                                            ...
                                            <td class="center aligned" width="130px;">
                                                <div class="ui buttons clearfix" style="margin-top: 10px;">
                                                    <a class="ui teal mini button" href="${ITBCAdmin}/user/edit/edit-user?userId=${item.userId}">修改</a>
                                                    <div class="or"></div>
                                                    <a class="ui orange mini button" href="${ITBCAdmin}/user/delete/${item.userId}">删除</a>
                                                </div>
                                            </td>
                                        </tr>
                                    </#if>
